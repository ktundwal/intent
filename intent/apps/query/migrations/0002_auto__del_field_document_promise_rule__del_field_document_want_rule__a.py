...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.promise_rule'
        db.delete_column('query_document', 'promise_rule_id')

        # Deleting field 'Document.want_rule'
        db.delete_column('query_document', 'want_rule_id')

        # Adding field 'Document.text'
        db.add_column('query_document', 'text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True),
                      keep_default=False)

        # Adding field 'Document.buy_rule'
        db.add_column('query_document', 'buy_rule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='buys', null=True, to=orm['query.Rule']),
                      keep_default=False)

        # Adding field 'Document.recommendation_rule'
        db.add_column('query_document', 'recommendation_rule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='recommendations', null=True, to=orm['query.Rule']),
                      keep_default=False)

        # Adding field 'Document.commitment_rule'
        db.add_column('query_document', 'commitment_rule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='commitments', null=True, to=orm['query.Rule']),
                      keep_default=False)

        # Adding field 'Document.like_rule'
        db.add_column('query_document', 'like_rule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='likes', null=True, to=orm['query.Rule']),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Document.promise_rule'
        db.add_column('query_document', 'promise_rule',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='promises', null=True, to=orm['query.Rule'], blank=True),
                      keep_default=False)

        # Adding field 'Document.want_rule'
        db.add_column('query_document', 'want_rule',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='wants', null=True, to=orm['query.Rule'], blank=True),
                      keep_default=False)

        # Deleting field 'Document.text'
        db.delete_column('query_document', 'text')

        # Deleting field 'Document.buy_rule'
        db.delete_column('query_document', 'buy_rule_id')

        # Deleting field 'Document.recommendation_rule'
        db.delete_column('query_document', 'recommendation_rule_id')

        # Deleting field 'Document.commitment_rule'
        db.delete_column('query_document', 'commitment_rule_id')

        # Deleting field 'Document.like_rule'
        db.delete_column('query_document', 'like_rule_id')
