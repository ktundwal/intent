...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('query_query', (
            ...
            ('latitude', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
            ('longitude', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
            ('radius', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'query.intent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intent': ('django.db.models.fields.CharField', [], {'max_length': '40'})
        },
        'query.query': {
        ...
        'query.runningstate': {
            'Meta': {'object_name': 'RunningState'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'query': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['query.Query']"}),
        ...
        'query.tweet': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['query.Intent']"}),
            ...
            'tweet_id': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
