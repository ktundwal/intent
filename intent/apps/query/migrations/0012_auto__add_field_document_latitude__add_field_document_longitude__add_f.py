...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.latitude'
        db.add_column('query_document', 'latitude',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)

        # Adding field 'Document.longitude'
        db.add_column('query_document', 'longitude',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)

        # Adding field 'Document.display_location'
        db.add_column('query_document', 'display_location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Document.latitude'
        db.delete_column('query_document', 'latitude')

        # Deleting field 'Document.longitude'
        db.delete_column('query_document', 'longitude')

        # Deleting field 'Document.display_location'
        db.delete_column('query_document', 'display_location')
    ...
    models = {
        ...
        'query.document': {
            ...
            'display_location': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
