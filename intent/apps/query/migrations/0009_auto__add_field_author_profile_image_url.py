...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('query_author', 'profile_image_url',
                      self.gf('django.db.models.fields.URLField')(default='http://i.stack.imgur.com/TDbOb.png', max_length=200),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Author.profile_image_url'
        db.delete_column('query_author', 'profile_image_url')
