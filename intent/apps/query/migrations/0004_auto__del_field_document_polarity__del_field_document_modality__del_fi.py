...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.polarity'
        db.delete_column('query_document', 'polarity')

        # Deleting field 'Document.modality'
        db.delete_column('query_document', 'modality')

        # Deleting field 'Document.intent'
        db.delete_column('query_document', 'intent')

        # Deleting field 'Document.subjectivity'
        db.delete_column('query_document', 'subjectivity')

    def backwards(self, orm):
        # Adding field 'Document.polarity'
        db.add_column('query_document', 'polarity',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=2, decimal_places=1),
                      keep_default=False)

        # Adding field 'Document.modality'
        db.add_column('query_document', 'modality',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=2, decimal_places=1),
                      keep_default=False)

        # Adding field 'Document.intent'
        db.add_column('query_document', 'intent',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'Document.subjectivity'
        db.add_column('query_document', 'subjectivity',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=2, decimal_places=1),
                      keep_default=False)
