...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.industry_terms_comma_separated'
        db.add_column('query_query', 'industry_terms_comma_separated',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Query.competitors_comma_separated'
        db.add_column('query_query', 'competitors_comma_separated',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Query.industry_terms_comma_separated'
        db.delete_column('query_query', 'industry_terms_comma_separated')

        # Deleting field 'Query.competitors_comma_separated'
        db.delete_column('query_query', 'competitors_comma_separated')
