...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyStat.stat_for'
        db.alter_column('query_dailystat', 'stat_for', self.gf('django.db.models.fields.DateField')())
    def backwards(self, orm):

        # Changing field 'DailyStat.stat_for'
        db.alter_column('query_dailystat', 'stat_for', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    models = {
        'auth.group': {
