...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.text'
        db.alter_column('query_document', 'text', self.gf('django.db.models.fields.CharField')(max_length=200))
    def backwards(self, orm):

        # Changing field 'Document.text'
        db.alter_column('query_document', 'text', self.gf('django.db.models.fields.CharField')(max_length=140))
    models = {
        'auth.group': {
