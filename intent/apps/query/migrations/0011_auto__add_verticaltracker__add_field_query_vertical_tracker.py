...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VerticalTracker'
        db.create_table('query_verticaltracker', (
        ...
        db.send_create_signal('query', ['VerticalTracker'])

        # Adding field 'Query.vertical_tracker'
        db.add_column('query_query', 'vertical_tracker',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='trackers', null=True, blank=True, to=orm['query.VerticalTracker']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'VerticalTracker'
        db.delete_table('query_verticaltracker')

        # Deleting field 'Query.vertical_tracker'
        db.delete_column('query_query', 'vertical_tracker_id')
