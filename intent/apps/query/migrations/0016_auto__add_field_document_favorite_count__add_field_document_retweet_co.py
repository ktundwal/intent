...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.favorite_count'
        db.add_column('query_document', 'favorite_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Document.retweet_count'
        db.add_column('query_document', 'retweet_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Document.place'
        db.add_column('query_document', 'place',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.favorite_count'
        db.delete_column('query_document', 'favorite_count')

        # Deleting field 'Document.retweet_count'
        db.delete_column('query_document', 'retweet_count')

        # Deleting field 'Document.place'
        db.delete_column('query_document', 'place')
    ...
    models = {
        ...
        'query.document': {
            ...
            'place': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
