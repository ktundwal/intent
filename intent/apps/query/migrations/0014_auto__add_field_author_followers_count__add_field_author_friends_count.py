...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('query_author', 'followers_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Author.friends_count'
        db.add_column('query_author', 'friends_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('query_author', 'followers_count')

        # Deleting field 'Author.friends_count'
        db.delete_column('query_author', 'friends_count')
