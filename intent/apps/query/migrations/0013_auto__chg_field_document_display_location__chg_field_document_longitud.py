...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.display_location'
        db.alter_column('query_document', 'display_location', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Document.longitude'
        db.alter_column('query_document', 'longitude', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Document.latitude'
        db.alter_column('query_document', 'latitude', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
    def backwards(self, orm):

        # Changing field 'Document.display_location'
        db.alter_column('query_document', 'display_location', self.gf('django.db.models.fields.CharField')(default='', max_length=40))

        # Changing field 'Document.longitude'
        db.alter_column('query_document', 'longitude', self.gf('django.db.models.fields.CharField')(default='', max_length=40))

        # Changing field 'Document.latitude'
        db.alter_column('query_document', 'latitude', self.gf('django.db.models.fields.CharField')(default='', max_length=40))
    models = {
        'auth.group': {
