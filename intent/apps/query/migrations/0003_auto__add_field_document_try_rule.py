...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.try_rule'
        db.add_column('query_document', 'try_rule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tries', null=True, to=orm['query.Rule']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Document.try_rule'
        db.delete_column('query_document', 'try_rule_id')
