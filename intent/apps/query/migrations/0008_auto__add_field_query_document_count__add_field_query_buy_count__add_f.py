...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.document_count'
        db.add_column('query_query', 'document_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Query.buy_count'
        db.add_column('query_query', 'buy_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Query.recommendation_count'
        db.add_column('query_query', 'recommendation_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Query.question_count'
        db.add_column('query_query', 'question_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Query.commitment_count'
        db.add_column('query_query', 'commitment_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Query.like_count'
        db.add_column('query_query', 'like_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Query.dislike_count'
        db.add_column('query_query', 'dislike_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Query.try_count'
        db.add_column('query_query', 'try_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Query.document_count'
        db.delete_column('query_query', 'document_count')

        # Deleting field 'Query.buy_count'
        db.delete_column('query_query', 'buy_count')

        # Deleting field 'Query.recommendation_count'
        db.delete_column('query_query', 'recommendation_count')

        # Deleting field 'Query.question_count'
        db.delete_column('query_query', 'question_count')

        # Deleting field 'Query.commitment_count'
        db.delete_column('query_query', 'commitment_count')

        # Deleting field 'Query.like_count'
        db.delete_column('query_query', 'like_count')

        # Deleting field 'Query.dislike_count'
        db.delete_column('query_query', 'dislike_count')

        # Deleting field 'Query.try_count'
        db.delete_column('query_query', 'try_count')
